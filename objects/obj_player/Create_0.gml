...
FOOTSTEP_VOL_MIN = 0.20;
FOOTSTEP_VOL_MAX = 0.38;
FOOTSTEP_VOL_CAVE = 0.6;                 // Extra distance muffling on top of pitch
...
FOOTSTEP_LAND_VOL_MIN = 0.28;
FOOTSTEP_LAND_VOL_MAX = 0.48;
